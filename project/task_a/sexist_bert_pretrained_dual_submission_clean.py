...
def create_submission():
    ...
    # get model
    model = build_model(model_path="../trained_agents/sexist_bert_pretrained_dual_a_clean_e1.pt").cuda()
    model.eval()

    # get the data loader
    data_loader = DataLoader(
        batch_size=16,
        data_path="../data/custom/dev_task_a_entries_corrected.csv",
        shuffle=False,
    ...
    # save the dataframe
    df.to_csv("../data/semeval/submission_task_a/dev/v2/sexist_bert_dual_clean_e2.csv", index=False)
