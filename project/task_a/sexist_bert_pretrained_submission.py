...
def create_submission():
    ...
    # get model
    model = build_model(model_path="../trained_agents/sexist_bert_pretrained_a_custom_full_r_e1.pt").cuda()
    model.eval()
    ...
    # save the dataframe
    df.to_csv("../data/semeval/submission_task_a/dev/sexist_bert_custom_full_r_e1.csv", index=False)
